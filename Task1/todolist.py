...
def main():
    ...
    add = tk.Button(buttons, text="Add Task",fg="#0B2447", font=("Times New Roman", 15),bg="white",borderwidth=0 , command=lambda: add_task(list_of_tasks, enter_task))
    add.pack(side=tk.LEFT,padx=5)
    
    update = tk.Button(buttons, text="Update Task",fg="#0B2447", font=("Times New Roman", 15),bg="white" , borderwidth=0 ,command=lambda: update_task(list_of_tasks, enter_task))
    update.pack(side=tk.LEFT,padx=5)

    delete = tk.Button(buttons, text="Delete Task", fg="#0B2447",font=("Times New Roman", 15),bg="white" , borderwidth=0 ,command=lambda: delete_task(list_of_tasks))
    delete.pack(side=tk.LEFT,padx=5)

    clear = tk.Button(buttons, text="Clear All",fg="#0B2447", font=("Times New Roman", 15),bg="white" , borderwidth=0 ,command=lambda: clear_tasks(list_of_tasks))
